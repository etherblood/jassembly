...
public enum Command {
    ...
    FROM_SB(set(OP_ADR, ADD_ADR) | set(R0_ADR, SB_ADR) | set(W_ADR, ACC_ADR)),
    TO_SB(set(OP_ADR, ADD_ADR) | set(R0_ADR, ACC_ADR) | set(W_ADR, SB_ADR)),
    FROM_SP(set(OP_ADR, ADD_ADR) | set(R0_ADR, SP_ADR) | set(W_ADR, ACC_ADR)),
    TO_SP(set(OP_ADR, ADD_ADR) | set(R0_ADR, ACC_ADR) | set(W_ADR, SP_ADR)),

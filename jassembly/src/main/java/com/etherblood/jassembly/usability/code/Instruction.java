...
public enum Instruction {
    ...
    INVERT_AX(set(OP_ADR, LU_ADR) | set(OP_ARG, LU_OR) | set(R0_ADR, AX_ADR) | set(W_ADR, AX_ADR) | set(R0_MOD, MOD_INV)),
    REVERT_AX(set(OP_ADR, LU_ADR) | set(OP_ARG, LU_OR) | set(R0_ADR, AX_ADR) | set(W_ADR, AX_ADR) | set(R0_MOD, MOD_REV)),
    ANY_AX(set(OP_ADR, LU_ADR) | set(OP_ARG, LU_OR) | set(R0_ADR, AX_ADR) | set(W_ADR, AX_ADR) | set(R0_MOD, MOD_ANY)),

...
import com.etherblood.jassembly.compile.jassembly.language.LanguageCompilationContext;
...
import com.etherblood.jassembly.compile.jassembly.language.ast.statement.block.BlockItem;
import com.etherblood.jassembly.compile.jassembly.language.ast.statement.ReturnStatement;
import com.etherblood.jassembly.compile.jassembly.language.ast.expression.BinaryOperationExpression;
import com.etherblood.jassembly.compile.jassembly.language.ast.expression.BinaryOperator;
import com.etherblood.jassembly.compile.jassembly.language.ast.expression.ConstantExpression;
...
import com.etherblood.jassembly.compile.jassembly.language.ast.expression.FunctionCallExpression;
import com.etherblood.jassembly.compile.jassembly.language.ast.expression.UnaryOperationExpression;
import com.etherblood.jassembly.compile.jassembly.language.ast.expression.VariableExpression;
import com.etherblood.jassembly.compile.jassembly.language.ast.statement.AssignStatement;
import com.etherblood.jassembly.compile.jassembly.language.ast.statement.BreakStatement;
import com.etherblood.jassembly.compile.jassembly.language.ast.statement.ContinueStatement;
import com.etherblood.jassembly.compile.jassembly.language.ast.statement.block.VariableDeclaration;
import com.etherblood.jassembly.compile.jassembly.language.ast.statement.ExpressionStatement;
import com.etherblood.jassembly.compile.jassembly.language.ast.statement.IfElseStatement;
import com.etherblood.jassembly.compile.jassembly.language.ast.statement.Statement;
import com.etherblood.jassembly.compile.jassembly.language.ast.statement.WhileStatement;
...
public class LanguageCompiler {
    ...
    public LanguageCompiler(Program program) {
        this.program = program;
        LanguageCompilationContext context = new LanguageCompilationContext();
    ...
    private ExpressionType functionCall(FunctionCallExpression call, LanguageCompilationContext context) {
    ...
    private void functionDeclaration(FunctionDeclaration function, LanguageCompilationContext context) {
        LanguageCompilationContext child = context.withFunctionScope(function);
        VariableDetails[] parameters = function.getParameters();
    ...
    private void block(Block block, LanguageCompilationContext context) {
        LanguageCompilationContext child = context.withNewScope();
    ...
    private void blockItem(BlockItem blockItem, LanguageCompilationContext context) {
    ...
    private void statement(Statement statement, LanguageCompilationContext context) {
    ...
    private ExpressionType expression(Expression expression, LanguageCompilationContext context) {
